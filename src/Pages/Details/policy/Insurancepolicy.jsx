...
const renderField = (fieldName, fieldValue) => {
  ...
  if (fieldValue !== undefined && fieldValue !== null) {
    ...
    // Handle objects with date/time properties (like the error shows)
    else if (typeof fieldValue === 'object') {
      // Check if it has date-related properties
      if (fieldValue.year && fieldValue.month && fieldValue.day) {
